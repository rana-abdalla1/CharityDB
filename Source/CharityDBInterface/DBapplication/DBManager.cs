...
namespace DBapplication
{
    ...
    {
        static string DB_Connection_String = @"Data Source=DESKTOP-SM12V1I\SQLEXPRESS;Initial Catalog=CharityDB;Integrated Security=True;MultipleActiveResultSets=true";
